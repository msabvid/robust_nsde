    ...
    def forward(self, S0, rate_daily, z, MC_samples, ind_T,n_maturities, maturities, timegrid,gradient_count): 
        ...
        for i in range(1, ind_T+1):
            ...
            if i in irand:
                ...
                V_new = V_old + self.V_drift.forward_idx(idx_net,V_old).detach().reshape(MC_samples,1)*h + self.V_vol.forward_idx(idx_net,V_old).detach().reshape(MC_samples,1)*dB
...
if __name__ == '__main__':
    ...
    gradient_count = int(0.25*n_steps_daily) # use 25% of timesteps to evaluate gradient for backpropagation
