...
def train_nsde(model,z_val,z_val_var,z_test,z_test_var,config):
    ...
    optimizer_vanilla_hedge = torch.optim.Adam(params_vanilla_hedge,lr=1*learning_rate)
    optimizer_SDE = torch.optim.Adam(params_SDE,lr=1*learning_rate)
    
    if args.hedge_exotic:
        optimizer_exotic_hedge = torch.optim.Adam(params_exotic_hedge,lr=10*learning_rate)
