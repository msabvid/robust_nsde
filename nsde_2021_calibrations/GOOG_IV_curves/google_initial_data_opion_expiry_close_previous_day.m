...
function [IV,IV_blend,IV_blend_smooth,VOL,K,Delta,ASK,BID,Price] = get_price_data(day,GOOG_date,maturities,GOOG_S0,rate,GOOG_mat,GOOG_IV,GOOG_VOL,GOOG_K,GOOG_BID,GOOG_ASK,GOOG_delta,number_strikes_for_each_maturity,GOOG_day,GOOG_month,GOOG_year,number_maturities_for_each_cal_day)
